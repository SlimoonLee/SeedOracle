...
当前状态（2026-09-06）：PR #43 已合并到作者 `main`，public API v5 最初进入合并提交 `0552b33`；作者工坊条目现为 `0.31.2` 并包含该 API。Seed Oracle `0.1.21` 已直接按工坊 DLL 构建，本地 API 版不再部署；本文件中 `0.29.x`/`0.31.1` 的版本号和 runId 保留为历史验证记录，不代表当前依赖。
